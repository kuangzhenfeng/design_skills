...
|------|-------|:-------:|:------:|------|
| 🥇 1 | **ultra-design** | **9.0 / 10** | ✅ | 本地 `skills_for_benchmark/ultra-design/SKILL.md` |
| 🥇 1 | **ultra-design-pro**（纯 2D · 流星夜空液态玻璃 · 可调透明度） | **9.0 / 10** | ✅ | 本地 `skills_for_benchmark/ultra-design-pro/SKILL.md` |
