...
# Ultra Design v2 — Liquid Glass 设计系统（Motion 驱动）

## 概述

Ultra Design v2 是一套基于 **Liquid Glass（液态玻璃）** 设计语言的前端规范，技术栈默认 **TypeScript + React + Next.js + Tailwind CSS + shadcn/ui + Radix + Motion**。
